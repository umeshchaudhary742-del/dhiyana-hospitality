...
const weeklyMenu = [
  {
    day: "Monday",
    breakfast: "Tea / Coffee / Milk • Idli sambhar / mendu wada",
    lunch: "Chole masala chatpata tarii, Puri less oily, Sweets- Gulab Jamun, Salad WITH CHUKANDAR, Jeera rice, Toor Dal",
    snacks: "Tea/ coffee / Milk • Methi Gota/ Chatni/Bhel",
    dinner: "Suran, Roti butter, Rice, Butter Milk, Chana dal",
  },
  {
    day: "Tuesday",
    breakfast: "Tea / Coffee / Milk • Usal-poha/ Sev poha",
    lunch: "Paneer Aloo Matar/Any other Beans, Chana masala, Butter Roti, Masoor daal, Rice, curd, Salad",
    snacks: "Tea/ coffee / Milk • Gol gappa",
    dinner: "Galka, ROTI, rice, Butter Milk, mix salad, CHANA DAL",
  },
  {
    day: "Wednesday",
    breakfast: "Tea / Coffee / Milk • Aaloo puri",
    lunch: "Mix veg Dry, Kadhi Pakoda, Roti, jeera rice, moong sprouts",
    snacks: "Tea/ coffee / Milk • Samosa Green chutney",
    dinner: "Chole masala chatpata tarii, Butter milk, Udad daal, Jeera rice, Paratha / Bhatura",
  },
  {
    day: "Thursday",
    breakfast: "Tea / Coffee / Milk • Aloo paratha",
    lunch: "Malai Kofta Gravy, Rajma masala, Toor dal, Roti, Rice, Butter milk, Salad",
    snacks: "Tea/ coffee / Milk • Sweet corn MIX WITH MASALA/Pasta",
    dinner: "Manchurian separate, Roti, Fried rice, Fryms different, Cucumber Raita, Aloo bhujiya (Dry)",
  },
  {
    day: "Friday",
    breakfast: "Tea / Coffee / Milk • THEPLA- achaar",
    lunch: "Kadhai paneer, Matki, Daal Makhani, Roti, Rice, dahi, Salad",
    snacks: "Tea/ coffee / Milk • GRILLED SANDWICH (Aloo sandwich)/ Fruits",
    dinner: "Kadi, khichdi, Loki Chana, Roti, Roasted papad, Mix salad, Or Dal bati",
  },
  {
    day: "Saturday",
  ...
  {
    day: "Sunday",
    breakfast: "Tea / Coffee / Milk • BATATA POHA/ Khaman",
    lunch: "Capsicum masala, Roti, Toor Dal, Rice, Butter milk, Salad",
    snacks: "Tea/ coffee / Milk • toast",
    dinner: "Pav -Bhaji, Veg-Biryani, boondi raita, Mix salad (Onion, Nimbu)",
  },
];
